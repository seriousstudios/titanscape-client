...
public class RSFont extends Rasterizer2D {
    ...
    public void drawTransparentCharacter(int i, int i_11_, int i_12_, int i_13_, int i_14_,
        ...
        int i_17_ = i_11_ + i_12_ * Rasterizer2D.rasterWidth;
        int i_18_ = Rasterizer2D.rasterWidth - i_13_;
        int i_19_ = 0;
        int i_20_ = 0;
        if (i_12_ < Rasterizer2D.topY) {
            ...
            i_20_ += i_21_ * i_13_;
            i_17_ += i_21_ * Rasterizer2D.rasterWidth;
        }
        ...
        if (i_13_ > 0 && i_14_ > 0) {
            createTransparentCharacterPixels(Rasterizer2D.rasterPixels, fontPixels[i], i_15_, i_20_, i_17_, i_13_, i_14_, i_18_, i_19_, i_16_);
        }
    }
    ...
    public void drawCharacter(int character, int i_35_, int i_36_, int i_37_, int i_38_,
        ...
        int i_40_ = i_35_ + i_36_ * Rasterizer2D.rasterWidth;
        int i_41_ = Rasterizer2D.rasterWidth - i_37_;
        int i_42_ = 0;
        int i_43_ = 0;
        if (i_36_ < Rasterizer2D.topY) {
            ...
            i_43_ += i_44_ * i_37_;
            i_40_ += i_44_ * Rasterizer2D.rasterWidth;
        }
        ...
        if (i_37_ > 0 && i_38_ > 0) {
            createCharacterPixels(Rasterizer2D.rasterPixels, fontPixels[character],
