...
public final class GameFont extends Rasterizer2D {
    ...
    private void method392(byte abyte0[], int i, int j, int k, int l, int i1) {
        int j1 = i + j * rasterWidth;
        int k1 = rasterWidth - k;
        int l1 = 0;
        int i2 = 0;
        if (j < topY) {
            int j2 = topY - j;
        ...
        if (!(k <= 0 || l <= 0)) {
            method393(rasterPixels, abyte0, i1, i2, j1, k, l, k1, l1);
        }
    }
    ...
    private void method394(int i, int j, byte abyte0[], int k, int l, int i1,
                           int j1) {
        int k1 = j + l * rasterWidth;
        int l1 = rasterWidth - k;
        int i2 = 0;
        int j2 = 0;
        if (l < topY) {
            int k2 = topY - l;
        ...
        if (k <= 0 || i1 <= 0)
            return;
        method395(abyte0, i1, k1, rasterPixels, j2, k, i2, l1, j1, i);
    }
